...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment action="<c:url value='/do/pay' />"  method=post
			target="_blank">
		...
		<form name=tradequery action="<c:url value='/do/query' />"  method=post
			target="_blank">
		...
		<form name=traderefund action="<c:url value='/do/refund' />" method=post
			target="_blank">
		...
		<form name=traderefundquery
			action="<c:url value='/do/refundQuery' />" method=post
			target="_blank">
		...
		<form name=tradeclose action="<c:url value='/do/close' />"  method=post
			target="_blank">
